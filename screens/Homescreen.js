...
const Item = ({ time, title, calories }) => (
    <View style={{ backgroundColor: colors.primary, borderRadius: 5,  marginBottom: 10, alignItems: 'center', flexDirection: 'row', width: 300}}>
    ...
    return(
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={{alignItems: 'center', paddingTop: 50}}>
                <Text style={{fontSize: 40}}>Your today's intake</Text>
